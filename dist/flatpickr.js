...
function Flatpickr(element, config) {
	...
	function setupFormats() {
		self.formats = {
			...
			D: function (date) { return l10n(self.config.locale).weekdays.shorthand[self.formats.w(date)]; },
			...
			J: function (date) { return date.getDate() + l10n(self.config.locale).ordinal(date.getDate()); },
			...
			l: function (date) { return l10n(self.config.locale).weekdays.longhand[self.formats.w(date)]; },
	...
	function l10n(locale) {
		if (typeof self.l10n_selected !== "undefined")
